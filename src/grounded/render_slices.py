...
def slice_output_path(config: GroundedConfig, slice_spec: Spec) -> Path:
    return (
...
def slice_style_source(config: GroundedConfig, slice_spec: Spec) -> Path | None:
...
def slice_style_output_path(config: GroundedConfig, slice_spec: Spec) -> Path | None:
